...
selected_answer, NOT_judge_agent_call = choose_ans_based_on_selector(confidence_checker_result, results_all, hallucination_threshold = hallucination_threshold)
...
if NOT_judge_agent_call:
    ...
    final_answer = agent_result['output']['Answer']
